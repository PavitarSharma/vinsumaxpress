        ...
        <div className="md:pt-32 pt-28 pb-10 grid md:grid-cols-2">
          <div className="flex flex-col gap-6">
            <h1 className="sm:text-5xl text-3xl font-bold uppercase leading-tight">
              WE WILL <span className="text-primary">DELIVER</span> YOUR PACKAGE
              ALL OVER <span className="text-primary">THE WORLD.</span>
            </h1>
            <div className="px-4 !h-10 rounded w-full bg-zinc-400/50 slider">

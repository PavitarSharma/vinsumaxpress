...
export default function CylinderCards({ activeIndex }) {
  ...
  return (
    <div
        className="flex items-center justify-center mt-10 h-full"
        ...
        >
            ...
            return (
                <div
                key={card.id}
                className={`absolute w-fit h-fit rounded-5xl p-5 shadow-xl bg-white text-black transition-opacity duration-500 antialiased ${
